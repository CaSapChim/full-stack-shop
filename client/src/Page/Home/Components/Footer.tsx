      ...
      <div className="px-6">
        ...
        <div className="border-t-[1px] border-t-slate-900/10 py-6">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              <h4 className="font-semibold text-slate-900">Theo dõi bản tin của chúng tôi</h4>
              <p className="mt-2 text-sm text-slate-600">
                Tin tức và tài nguyên mới nhất được gửi tới mail đến
                của bạn hàng tuần
              </p>
            </div>
        ...
        <div className="border-t-[1px] border-t-slate-900/10 py-5">
          <div className="flex flex-col justify-center text-sm text-slate-600 md:flex-row md:justify-between ">
